...
blend_path = r"J:\personal work\2025\Hippie Camp turned into Uzlet for Salik\Uzlat 4.1.1.blend"
scene_name = "030_Uzlat"
...
def update_manifest(files):
    ...
    sorted_manifest = dict(sorted(manifest.items(), key=lambda t: t[0]))
