...
blend_path = r"J:\personal work\2023 sonu\Chibi in Desert\chibi in desertr new saved.blend"
scene_name = "028_ChibiDesert"
...
print(f"\n--- EXPORTING CHIBI IN DESERT AS SEPARATE PIECES ---")
